            ...
            Obx(
              () => AppBottomSheet<String>(
                ...
                options: [
                  ...
                  BottomSheetOption(value: 'Vata-Pitta', label: 'Vata-Pitta'),
                  BottomSheetOption(value: 'Pitta-Kapha', label: 'Pitta-Kapha'),
                  BottomSheetOption(value: 'Vata-Kapha', label: 'Vata-Kapha'),
                  BottomSheetOption(
                    value: 'Sama Prakriti',
                    label: 'Sama Prakriti',
                  ),
            ...
            Obx(
              () => AppBottomSheet<String>(
                ...
                options: [
                  ...
                  BottomSheetOption(value: 'Trembling', label: 'Trembling'),
